                      ...
                      <div class="border_inside">
                        <div class="prodc_img">
                          ...
                          <a href="{$product.link}" title="{$product.name|truncate:32:'...'|escape:'htmlall':'UTF-8'}" class="product-image product_image thumb">
                           <img src="{$link->getImageLink($product.link_rewrite, $product.id_image, 'large_default')|escape:'html':'UTF-8'}"  id="featuredproductImage_{$product.id_product}" />
                            ...
                            <div class="imgrelative">
                              <ul class="thumbs_list">
                                ...
                                <img id="thumb_{$image.id_image}_{$product.id_product}" src="{$link->getImageLink($product.link_rewrite, $imageIds, 'small_default')|escape:'html':'UTF-8'}" alt="{$product.name|escape:html:'UTF-8'}" class="featuredthumb_image"/> </li>
                                {/foreach}
                                {/if}
                              </ul>
                            </div>
                           ...
                           <img src="{$link->getImageLink($product.link_rewrite, $product.id_image, 'large_default')|escape:'html':'UTF-8'}"  id="newproproductImage_{$product.id_product}" />
                            ...
                            <div class="imgrelative">
                              <ul class="thumbs_list">
                                ...
                                <li id="thumbnail_{$image.id_image|escape:'intval'}" style="float:left;" class="thumbsimg"> 
                                <img id="thumb_{$image.id_image}_{$product.id_product}" src="{$link->getImageLink($product.link_rewrite, $imageIds, 'small_default')|escape:'html':'UTF-8'}" alt="{$product.name|escape:html:'UTF-8'}" class="newprothumb_image"/> </li>
                                {/foreach}
                                {/if}
                              </ul>
                            </div>
                           ...
                           <img src="{$link->getImageLink($product.link_rewrite, $product.id_image, 'large_default')|escape:'html':'UTF-8'}"  id="topsellproductImage_{$product.id_product}" />
                            ...
                            <div class="imgrelative">
                              <ul class="thumbs_list">
                                ...
                                <li id="thumbnail_{$image.id_image|escape:'intval'}" style="float:left;" class="thumbsimg"> 
                                <img id="thumb_{$image.id_image}_{$product.id_product}" src="{$link->getImageLink($product.link_rewrite, $imageIds, 'small_default')|escape:'html':'UTF-8'}" alt="{$product.name|escape:html:'UTF-8'}" class="topsellthumb_image"/> </li>
                                {/foreach}
                                {/if}
                              </ul>
                            </div>
                           ...
                           <img src="{$link->getImageLink($product.link_rewrite, $product.id_image, 'large_default')|escape:'html':'UTF-8'}"  id="specialproductImage_{$product.id_product}" />
                            ...
                            <div class="imgrelative">
                              <ul class="thumbs_list">
                                ...
                                <li id="thumbnail_{$image.id_image|escape:'intval'}" style="float:left;" class="thumbsimg"> 
                                <img id="thumb_{$image.id_image}_{$product.id_product}" src="{$link->getImageLink($product.link_rewrite, $imageIds, 'small_default')|escape:'html':'UTF-8'}" alt="{$product.name|escape:html:'UTF-8'}" class="specialthumb_image"/> </li>
                                {/foreach}
                                {/if}
                              </ul>
                            </div>
