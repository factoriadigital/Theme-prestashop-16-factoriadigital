...
{foreach name=langs from=$htmlitems.items key=lang item=langItems}
	...
	{foreach name=hooks from=$langItems key=hook item=hookItems}
		<h4 class="hook-title">{l s='Hook' mod='blockfactothemeconfigurator'} "{$hook|escape:'htmlall':'UTF-8'}"</h4>
		{if $hookItems}
						...
						<form method="post" action="{$htmlitems.postAction|escape:'htmlall':'UTF-8'}" enctype="multipart/form-data" class="item-form defaultForm  form-horizontal">
							<div class="btn-group pull-right">
								<button class="btn btn-default button-edit">
									<span class="button-edit-edit"><i class="icon-edit"></i> {l s='Edit' mod='blockfactothemeconfigurator'}</span>
									<span class="button-edit-close hide"><i class="icon-remove"></i> {l s='Close' mod='blockfactothemeconfigurator'}</span>
								</button>
								...
								<ul class="dropdown-menu">
									<li>
										<a href="{$htmlitems.postAction|escape:'htmlall':'UTF-8'}&amp;removeItem&amp;item_id={$hItem.id_item|escape:'htmlall':'UTF-8'}" name="removeItem" class="link-item-delete">
											<i class="icon-trash"></i> {l s='Delete item' mod='blockfactothemeconfigurator'}
										</a>
									</li>
								</ul>
							</div>
							...
							<br>
							{if $hItem.image}
								<img src="{$module_dir}views/img/{$hItem.image}" rel="#comments_{$hItem.id_item}" class="preview img-thumbnail" />
							{/if}
							<div class="item-container clearfix">
									...
									<div class="col-lg-9 col-lg-offset-3">
										<div class="checkbox">
											<label class="control-label">
												{l s='Enable' mod='blockfactothemeconfigurator'}
								...
								<div class="title item-field form-group">
									<label class="control-label col-lg-3">{l s='Image title' mod='blockfactothemeconfigurator'}</label>
									<div class="col-lg-7">
								...
								<div class="title_use item-field form-group">
									<div class="col-lg-9 col-lg-offset-3">
										<div class="checkbox">
											<label class="control-label">
												{l s='Use title in front' mod='blockfactothemeconfigurator'}
								...
								<div class="hook item-field form-group">
									<label class="control-label col-lg-3">{l s='Hook to which the image should be attached' mod='blockfactothemeconfigurator'}</label>
									<div class="col-lg-7">
										<select name="item_hook" default="home" class="fixed-width-lg">
                                            ...
                                            <option value="factoadvertisehome01"{if $hItem.hook == 'factoadvertisehome01'} selected="selected"{/if}>factoadvertisehome01</option>
                                            <option value="factoadvertisehome02"{if $hItem.hook == 'factoadvertisehome02'} selected="selected"{/if}>factoadvertisehome02</option>
                                            <option value="factoadvertisehome03"{if $hItem.hook == 'factoadvertisehome03'} selected="selected"{/if}>factoadvertisehome03</option>
											<option value="footer"{if $hItem.hook == 'footer'} selected="selected"{/if}>footer</option>
										</select>
									</div>
								</div>
								<div class="image item-field form-group">
									<label class="control-label col-lg-3">{l s='Load your image' mod='blockfactothemeconfigurator'}</label>
									<div class="col-lg-7">
										<input type="file" name="item_img" />
									</div>
								</div>
								<div class="image_w item-field form-group">
									<label class="control-label col-lg-3">{l s='Image width' mod='blockfactothemeconfigurator'}</label>
									<div class="col-lg-7">
										<div class="input-group fixed-width-lg">
											<input name="item_img_w" type="text" maxlength="4" size="4" value="{$hItem.image_w|escape:'htmlall':'UTF-8'}"/>
											<span class="input-group-addon">{l s='pixels' mod='blockfactothemeconfigurator'}</span>
										</div>
									</div>
								</div>
								<div class="image_h item-field form-group">
									<label class="control-label col-lg-3">{l s='Image height' mod='blockfactothemeconfigurator'}</label>
									<div class="col-lg-7">
										<div class="input-group fixed-width-lg">
								...
								<div class="url item-field form-group">
									<label class="control-label col-lg-3">{l s='Target link' mod='blockfactothemeconfigurator'}</label>
									<div class="col-lg-7">
								...
								<div class="target item-field form-group">
									<div class="col-lg-9 col-lg-offset-3">
										<div class="checkbox">
											<label class="control-label">
												{l s='Open link in a new tab/page' mod='blockfactothemeconfigurator'}
								...
								<div class="html item-field form-group">
									<label class="control-label col-lg-3">{l s='Optional HTML code' mod='blockfactothemeconfigurator'}</label>
									<div class="col-lg-7">
								...
								<div class="form-group">
									<div class="col-lg-7 col-lg-offset-3">
										<button type="button" class="btn btn-default button-item-edit-cancel" >
											<i class="icon-remove"></i> {l s='Cancel' mod='blockfactothemeconfigurator'}
										</button>
										<button type="submit" name="updateItem" class="btn btn-success button-save pull-right" >
											<i class="icon-save"></i> {l s='Save' mod='blockfactothemeconfigurator'}
										</button>
									</div>
								</div>
							</div>
		...
		{else}
			<div class="item">
				<span class="text-muted">{l s='No items available' mod='blockfactothemeconfigurator'}</span>
			</div>
		{/if}
	{/foreach}
	</div>
