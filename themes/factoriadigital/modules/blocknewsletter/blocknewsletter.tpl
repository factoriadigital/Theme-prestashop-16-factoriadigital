...
<section id="newsletter_block_left" class="footer-block col-xs-12 col-omi-xs5 blocks">
	<h4>{l s='Newsletter' mod='blockredfoxnewsletter'}</h4>
...
{/if}
{addJsDefL name=placeholder_blocknewsletter}{l s='Enter your e-mail' mod='blockredfoxnewsletter' js=1}{/addJsDefL}
{if isset($msg) && $msg}
	{addJsDefL name=alert_blocknewsletter}{l s='Newsletter : %1$s' sprintf=$msg js=1 mod="blockredfoxnewsletter"}{/addJsDefL}
{/if}
{/strip}